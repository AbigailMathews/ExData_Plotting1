...
# This script creates a lineplot of Global Active Power against datetime, from a subset 
# of the household power consumption dataset. Because the source data is contained in a
...
# Create plot 2 in a png file, plot2.png
png(file = "plot2.png")
